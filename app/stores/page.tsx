...
export default async function StoresPage({
  ...
  return (
    <div data-testid="stores-page">
      ...
      <section className="border-b border-ink/10 bg-[#f3f6fa] py-10 sm:py-12" data-testid="popular-stores">
      ...
      <section className="bg-white py-10 sm:py-14" data-testid="all-stores" id="all-stores">
        <div className="mx-auto max-w-[1366px] px-6">
          ...
          <div className="mt-4 border border-ink/10 bg-[#f3f6fa] p-4">
    ...
    <section className="page-hero">
      <div className="page-hero-inner">
        ...
        <p className="page-hero-desc">
              Browse popular retailers or search the full directory of {totalStores.toLocaleString()} coupon
              stores. Filter by country, category, or opening letter to narrow things down. Each store has its
              own page listing the codes and offers we currently hold.
            </p>
